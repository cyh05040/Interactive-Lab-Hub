...
try:
    ...
    draw.text((110, 60), 'WE LIKE SHARING', font = font15, fill = 0)
    draw.text((110, 60), 'AND', font = font15, fill = 0)
    draw.text((110, 60), 'SHARING IS CARING', font = font15, fill = 0)
    draw.text((110, 80), u'nani.today', font = font15, fill = 0)
