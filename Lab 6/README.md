...
>Two-Punch-Man interactive boxing device creates an unique experience that not only help you meet your personal fitness goals but also keep the in person interaction fun at home. Let's take Tom and Jerry as example, if Tom punches hard onto the device, through raspberry pi the deice would record the force applied by Tom, read it back to Tom in kilograms and send it to MQTT.   
